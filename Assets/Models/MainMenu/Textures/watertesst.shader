...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float l_1 = g_flTime * 17.5;
		float2 l_2 = TileAndOffsetUv( l_0.xy, float2( 1, 1 ), float2( l_1, l_1 ) );
		float2 l_3 = l_2 * float2( 0.0035, 0.0035 );
		float4 l_4 = Tex2DS( g_tTexture_ps_0, g_sSampler0, l_3 );
